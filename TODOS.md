...
- **LINE webhook URL always visible** — **DONE 2026-05-30, commit `this commit`.** Settings now always shows the platform webhook URL during LINE setup, and the Help popup uses the same URL instead of falling back to a placeholder.
