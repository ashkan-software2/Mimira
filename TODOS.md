...
- **Demo knowledge reseed** — **DONE 2026-05-30, commit `be0b996`.** Re-ran the existing `npm run seed:knowledge` pipeline so demo users have the previous `sample_clinic_knowledge` RAG corpus available again.
